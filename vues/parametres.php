                    ...
                    <div class="row">
                        <div class="col mb-5">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="<?=$dataAdresse->numero." ".$dataAdresse->voie?>">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">CODE POSTAL :</label>
                                <input type="text" class="form-control" placeholder="<?=$dataAdresse->code_postal?>">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">VILLE :</label>
                                <input type="email" class="form-control" placeholder="<?=$dataAdresse->ville?>">
                            </div>
                            <div class="mb-3">
