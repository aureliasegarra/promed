    ...
    <div class="main-wrapper">
        ...
        <div class="container">
         ...
         <div class="aboutbuttons">
                <a download="" href="static/images/patient.png" class="button button--flex">
					<img src="static/images/patient.png" alt="" class="img-rounded pull-left" width="150" ><i class="uil uil-download-alt buttonicon"></i>
                    </a>
                        </div>
